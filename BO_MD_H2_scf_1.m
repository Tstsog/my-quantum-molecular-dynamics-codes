...
N_step = 300;
%
fileID_save_data_1 = fopen('BO_MD_H2_scf_1.txt','w');
%
for ii = 1:N_step
    %
    ...
    RHS = dE_R0 - 1./R0^2; 
    Rt = 2*R0 - (1. - gamma*dt/(2*Mass_H))*R_old - (dt^2/Mass_H)*RHS; % 
    Rt = Rt/(1. + gamma*dt/(2*Mass_H));
    %
    R_old = R0;
    R0 = Rt;
    %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
read_md_data = fopen('BO_MD_H2_scf_1.txt', 'r');               % 
...
%Rint = 1.40; % internuclear separation
